...
export default function HomePage() {
  ...
  return (
    <PageFrame
      ...
      header={<ConversationHeader status={status} messageCount={messages.length} hasError={error != null} />}
      composer={<Composer value={input} status={status} onValueChange={handleInputChange} onSubmit={() => void handleSubmit()} />}
    >
